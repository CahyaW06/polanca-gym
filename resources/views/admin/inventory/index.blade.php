...
<div class="my-8 w-full" x-data="{target_id: 0, target_inv_id: 0, target_last_name: '', all_checked: false, prev_checked: true, }">
    <div class="relative mx-16 overflow-x-auto sm:rounded-lg">
        <div class=" bg-gray-900 flex justify-end">
            <button data-modal-target="store-modal" data-modal-toggle="store-modal" type="button" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-4 flex items-center text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800 py-2">Add Inventory</button>
        </div>
